	...
	<div class="pt-0 md:pt-10 xl:pt-16">
		<div class="container">
			...
			<div class="animate-ups">
				<div
					class="animate-ups__item py-5 xl:py-8 flex flex-wrap gap-3 md:gap-10 xl:gap-10 items-start xl:items-center justify-center">
		...
		<div class="container">
			<!-- TOGGLE -->
			<div class="animate-ups flex items-center xl:hidden">
										...
										<Popover>
											<PopoverTrigger as-child>
												<div
													...
													<span class="text-[#ADB2C0] xl:text-sm 3xl:text-lg">
														{{
															date
			...
			<div class="animate-ups pb-16 grid grid-cols-12 xl:gap-6 2xl:gap-8 3xl:gap-10">
				<div class="animate-ups__item col-span-3 hidden xl:flex flex-col xl:gap-8 3xl:gap-10">
					<div>
						<div class="flex items-center relative">
							<i>
				...
				<div class="animate-ups__item col-span-full xl:col-span-9">
