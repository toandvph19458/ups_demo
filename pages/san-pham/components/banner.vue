<template>
    <div
        ...
        <div class="flex flex-col items-center gap-[40px] sm:gap-[24px]">
            <p
                class="text-[#173025] text-center font-hanken xxl:text-[16px] lg:text-[12px] sm:text-[12px] text-[14px] xl:text-[12px] font-semibold leading-none tracking-[3.2px] uppercase">
                Khách hàng cá nhân
            </p>
            <p
                class="text-[var(--Black-Alpha---color-black-alpha-900,#000)] text-center font-bricolage xxl:text-[60px] lg:text-[32px] text-[45px] xl:text-[40px] sm:text-[20px] font-bold leading-none">
                Margin T+3
            </p>
            <p
                class="text-black/60 text-center font-hanken xxl:text-[18px] text-[14px] xl:text-[12px] lg:text-[12px] sm:text-[12px] font-medium leading-[30px] self-stretch w-full">
            ...
            <div class="btn-wrapper flex gap-5 sm:gap-2 items-center">
                ...
                <nuxt-link to="/" class="btn group animate-ups__item ">
        ...
        <div class="w-full xxl:h-[450px] h-[380px] md:h-[260px] xl:h-[350px] sm:h-[120px]">
