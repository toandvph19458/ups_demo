<template>
    <section class="animate-ups">
        <div
            class="xxl:px-[225px] lg:px-[100px] md:px-[60px] sm:px-6 xl:px-[120px] xxl:py-[100px] lg:py-[60px] xl:py-[80px] sm:py-10 self-stretch">
            ...
            <div
                ...
                <div class="w-full flex items-center flex-col ">
                    <Accordion type="single" class="w-2/3 xxl:w-3/4 sm:w-full lg:w-2/3" collapsible>
