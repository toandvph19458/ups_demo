<template>
	<section class="animate-ups">
		<div
			class="2xl:px-[225px] lg:px-[100px] md:px-[60px] sm:px-6 xl:px-[120px] 2xl:py-[100px] lg:py-[60px] xl:py-[80px] sm:py-10 self-stretch"
		>
			<div
			...
			>
				<div class="w-full">
					<p
						class="text-[#15171E] font-BG text-center font-bold text-[60px] xl:text-[40px] lg:text-[32px] sm:text-[20px] 2xl:text-[45px] leading-none 2xl:my-2 animate-ups__item"
					>
						Câu hỏi thường gặp về
						<span
							class="text-[#F51666] font-BG font-bold text-[60px] xl:text-[40px] lg:text-[32px] 2xl:text-[45px] sm:text-[20px] leading-none animate-ups__item"
						>
							Margin T+3
						</span>
					</p>
					<p
						class="text-black text-center font-HG font-medium text-[20px] xl:text-[14px] lg:text-[12px] sm:text-[12px] 2xl:text-[16px] leading-normal animate-ups__item"
					>
						...
						<AccordionItem :value="1">
							<AccordionTrigger class="flex items-center hover:no-underline">
								<div class="flex items-center">
									...
									<div class="ml-5">
										<p
											class="text-[#15171E] text-left font-semibold text-[30px] xl:text-[20px] lg:text-[16px] sm:text-[14px] 2xl:text-[24px] leading-normal animate-ups__item font-HG"
										>
