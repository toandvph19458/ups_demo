<template>
	<section class="animate-ups">
		<div
			class="flex w-full flex-col items-center 2xl:gap-[60px] gap-20 sm:gap-6 px-[225px] 2xl:px-[120px] xl:px-[120px] pt-[40px] 2xl:pb-[100px] pb-[80px] xl:pb-[60px] sm:p-6"
		>
			<div class="flex flex-col items-center gap-6 self-stretch">
				<div
					class="animate-ups__item inline-flex relative 2xl:w-[221px] w-[176px] xl:w-[132px] sm:w-[70px] 2xl:h-[100px] h-[80px] xl:h-[60px] sm:h-[32px]"
				>
					<nuxt-img
						format="webp"
						loading="lazy"
				...
				<div class="2xl:flex 2xl:flex-col 2xl:gap-3">
					<h3
						class="text-[#15171E] text-center font-BG 2xl:text-[60px] text-[45px] xl:text-[40px] sm:text-[20px] font-semibold leading-none animate-ups__item"
					>
						Vì sao nên đăng ký
						<span
							class="text-[#F51666] font-BG 2xl:text-[60px] text-[45px] xl:text-[40px] sm:text-[20px] font-semibold leading-none animate-ups__item"
							>Margin T+3</span
						>
					</h3>
					<p
						class="text-black/60 text-center font-HG 2xl:text-[20px] text-[14px] sm:text-[12px] font-medium leading-none p-2 animate-ups__item"
					>
