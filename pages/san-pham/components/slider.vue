<template>
    <div
        class="flex w-full flex-col items-center xxl:gap-[60px] gap-20 sm:gap-6 px-[225px] xxl:px-[120px] xl:px-[120px] pt-[40px] xxl:pb-[100px] pb-[80px] xl:pb-[60px] sm:p-6">
        <div class="flex flex-col items-center gap-6 self-stretch">
            <div
                class="animate-ups__item inline-flex relative xxl:w-[221px] w-[176px] xl:w-[132px] sm:w-[70px] xxl:h-[100px] h-[80px] xl:h-[60px] sm:h-[32px]">
                <nuxt-img format="webp" loading="lazy" alt="UPS" src="/logo/logo-cap-dark.png"
                    class="absolute w-full h-full object-cover" />
            </div>

            <div>
                <h3
                    class="text-[#15171E] text-center font-bricolage xxl:text-[60px] text-[45px] xl:text-[40px] sm:text-[20px] font-semibold leading-none">
                    Vì sao nên đăng ký
                    <span
                        class="text-[#F51666] font-bricolage xxl:text-[60px] text-[45px] xl:text-[40px] sm:text-[20px] font-semibold leading-none">Margin
                        T+3</span>
                </h3>
                <p
                    class="text-black/60 text-center font-hanken xxl:text-[20px] text-[14px] sm:text-[12px] font-medium leading-none p-2">
                    ...
                    thời
                    những biến động của thị trường và tối đa hóa lợi nhuận.
                </p>
            </div>
        </div>

        <div class="w-full min-h-min py-6 lg:h-[300px]">
            <swiper :modules="[SwiperNavigation]" :pagination="true" :loop="false" speed="800"
                ...
                <swiper-slide>
                    ...
                    <div class="relative hidden lg:block lg:min-h-[300px]">
                        <div class="w-full flex items-center justify-center ">
                            <div
                                class=" xxl:w-[351px] xxl:h-[363px] xl:w-[281px] xl:h-[290px] lg:w-[182px] lg:h-[189px] ">
                                <nuxt-img loading="lazy" alt="UPS" :src="`/images/Group.png`" class="w-full h-full" />
                            </div>
                        </div>

                        <div
                            class="flex xxl:p-6 xl:p-3 lg:p-3 flex-col items-start xxl:gap-3 xl:gap-1 lg:gap-1  rounded-xl xxl:w-[325px] xl:w-[250px] lg:w-[221px] xxl:h-[136px] bg-[linear-gradient(101deg,_#FFF35D_6.7%,_#F19F00_109.21%)] absolute xxl:bottom-0 xl:bottom-0 xxl:right-0 xl:right-0 lg:bottom-10 lg:right-[50px] ">
                            <p
                    ...
                    <div class="relative lg:hidden md:block sm:hidden  min-h-[260px] ">
                        <div class="w-full flex justify-center">
                            <div class="w-[182px] h-[189px]">
                                <nuxt-img loading="lazy" alt="UPS" :src="`/images/Group.png`" class="w-full h-full" />
                            </div>
                        </div>
                        <div
                    ...
                    <div class="relative md:hidden sm:block  min-h-[200px] ">
                        <div class="w-full flex justify-center ">
                            <div class="w-[140px] h-[145px]">
                                <nuxt-img loading="lazy" alt="UPS" :src="`/images/Group.png`" class="w-full h-full" />
                            </div>
                        </div>
                        <div
                ...
                <swiper-slide>
                    ...
                    <div class="relative hidden lg:block lg:min-h-[300px]">
                        <div class="w-full flex items-center justify-center">
                            <div
                                class=" xxl:w-[351px] xxl:h-[363px] xl:w-[281px] xl:h-[290px] lg:w-[182px] lg:h-[189px] ">
                                <nuxt-img loading="lazy" alt="UPS" :src="`/images/Frame 46.png`"
                                    class="w-full h-full" />
                            </div>
                        </div>
                ...
                <swiper-slide>
                    ...
                    <div class="relative hidden lg:block lg:min-h-[300px]">
                        <div class="w-full flex items-center justify-center">
                            <div
                                class=" xxl:w-[351px] xxl:h-[363px] xl:w-[281px] xl:h-[290px] lg:w-[182px] lg:h-[189px] ">
                                <nuxt-img loading="lazy" alt="UPS" :src="`/images/Group1.png`" class="w-full h-full" />
                            </div>
                        </div>
        ...
        <div class="xl:flex flex-col gap-6  items-center w-full hidden  xxl:mt-24">
                        ...
                        <button :class="cn(
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="12" viewBox="0 0 17 12"
                                ...
                                <path
                                    ...
                                    fill="#02E56A" :class="cn('transition-all duration-300 group-hover:fill-[#15171E]', {
