...
<template>
	<section class="">
		<!-- banner -->
		<div class="animate-ups w-full relative bg-[url('/background/bg-05.png')] bg-no-repeat md:bg-none">
			...
			<div
				...
				<div class="animate-ups__item relative sm:w-[110px] sm:h-[64px] md:w-[154px] md:h-[90px] xl:w-[248px] xl:h-[156px]">
				...
				<div class="container w-full flex flex-col items-start gap-3">
					...
					<h2 class="animate-ups__item md:text-[32px] xl:text-[50px] text-[#02E56A] font-bold sm:text-[24px] font-BG">
						Tin
		...
		<div class="container animate-ups">
			<div class="p-6 flex flex-col gap-6 md:py-[46px] lg:py-[46px] 2xl:py-[50px] 3xl:py-[70px]">
				...
				<div class="animate-ups__item flex flex-col w-full md:flex-row-reverse md:gap-6 xl:gap-10 3xl:gap-[60px]">
					<!-- card -->
					<div class="w-full flex-1">
						...
						<div v-if="data?.dataAnnouce?.announce_aggregated[0]?.count?.slug"
							...
							<Pagination v-slot="{ page }"
								:total="data?.dataAnnouce?.announce_aggregated[0]?.count?.slug" :sibling-count="10"
								show-edges :default-page="1" @update:page="handlePageUpdate">
					...
					<div
						...
						<div class="btn active inline-flex items-center justify-center cursor-pointer max-w-max"
							@click="handleReset">
							Xóa bộ lọc
						</div>
					</div>
