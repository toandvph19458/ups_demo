<template>
	<div>
			...
			<div class="container">
				<div class="max-w-[420px]">
					<h3 class="text-[76px] text-black font-BG font-semibold">
						<span class="text-[#E66D14] block">Vay ký quỹ </span>
						<span class="block">là gì ?</span>
					</h3>
					...
					<div class="p-[60px] bg-[#F8F8FF] rounded-[30px] relative">
						...
						>
							<i class="inline-flex">
								...
								>
									<path
										d="M9.17334 24.1995V21.4395"
										stroke="white"
										stroke-width="2"
										stroke-linecap="round"
									/>
									<path
										d="M16 24.1997V18.6797"
										stroke="white"
										stroke-width="2"
										stroke-linecap="round"
									/>
									<path
										d="M22.8267 24.1996V15.9062"
										stroke="white"
										stroke-width="2"
										stroke-linecap="round"
									/>
									...
									/>
									<path
										d="M18.9199 7.79883H22.8266V11.6922"
										stroke="white"
										stroke-width="2"
										stroke-linecap="round"
		...
		<div class="py-20 bg-gradient-to-r from-[#FFF35D] via-[#F4B93D] to-[#E66D14]">
			<div class="container">
				<div class="flex justify-between">
					<div class="max-w-[420px]">
						<h4>
							<span class="block text-black text-[50px] font-BG font-semibold">Lợi ích từ</span>
							<span class="block text-black text-[76px] font-BG font-semibold">Vay ký quỹ</span>
						</h4>
					...
					<div class="w-max">
						<div class="grid gap-5 grid-cols-3">
							<div
								class="min-w-[250px] p-5 rounded-[12px] border border-[rgba(236,230,255,0.5)] bg-[rgba(255,255,255,0.1)] shadow-[4px_4px_20px_rgba(191,150,224,0.16)]"
							>
		...
		<div class="py-[100px]">
			<div class="container">
				<div
					class="w-full h-[460px] bg-[url('/background/bg-06.png')] bg-cover bg-center rounded-[40px] relative"
				>
					<div class="absolute -bottom-[140px] left-1/2 -translate-x-1/2">
						<nuxt-img
							loading="lazy"
							format="webp"
