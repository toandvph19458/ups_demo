<template>
	<div class="container">
		<div class="flex justify-center text-center mt-[100px]">
			<div class="inline-flex relative w-[200px] h-[70px] xl:w-[220px] xl:h-[70px]">
				<nuxt-img
					loading="lazy"
					alt="UPS"
		...
		<div class="text-center mt-[30px] mb-[20px]">
			<h3 class="text-[#15171E] font-bricolage-grotesque xl:text-[50px] font-semibold leading-normal text-[24px]">
				Ông Trump nói về lạm phát, chỉ trích bà Harris trong cuộc vận động tranh cử ở Bắc Carolina
			</h3>
		</div>
		<div class="flex gap-2 text-center justify-center items-center">
			...
			<p class="text-[#7F8494] font-hanken-grotesk xl:text-[24px] font-semibold leading-normals text-[14px]">
				15/08/2024 - 22:20
			</p>
		</div>
		<div class="flex justify-center text-center xl:my-[80px] my-[30px]">
			<div class="inline-flex relative w-[327px] h-[208px] lg:w-[445px] lg:h-[208px] xl:w-[1600px] xl:h-[700px]">
				<nuxt-img
					loading="lazy"
					alt="UPS"
					src="/images/chi-tiet-banner.png"
					width="1600"
					height="700"
			...
			<div class="my-[40px] grid grid-cols-1 xl:grid-cols-3 gap-10">
				<div class="card">
					...
					<div class="flex justify-between items-center my-[24px]">
						<div class="tag text-[#F05] font-hanken-grotesk text-[18px] font-medium leading-normal">
							#Hotnews
						</div>
					...
					<div class="">
						<h6 class="text-[#15171E] font-hanken-grotesk text-[20px] font-semibold leading-normal">
							Nội dung tin tức
						</h6>
						<p class="text-[#3C4052] font-hanken-grotesk text-[18px] font-medium leading-normal mt-[8px]">
...
export default defineComponent({
	...
	setup(props, ctx) {
		...
		const { data } = useAsyncData("news-detail", async () => {
			...
			return {
				newDetail: dataDetail?.posts_by_id?.raw_content,
			};
		});

		console.log(data.value?.newDetail);
