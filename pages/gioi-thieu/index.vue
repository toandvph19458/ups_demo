  ...
  <div class="animate-about">
    ...
    <section
      ...
      <div class="absolute inset-0 py-[40px] md:py-[40px] lg:py-[80px] xl:py-[100px] 3xl:py-[140px]">
        <div class="container flex justify-start items-center h-full">
          <div class="basis-full md:basis-2/3 lg:basis-1/2 flex flex-col justify-between h-full">
        ...
        <div
          ...
          <div class="basis-full md:basis-1/2">
            ...
            <h3
              ...
              <span class="inline-block md:block text-green-ups">phát triển</span>
            </h3>
          </div>

          <div class="basis-full md:basis-1/2 flex flex-col gap-12 relative pb-10 md:pb-[60px] xl:pb-[100px]">
            <div class="group">
              <div :class="cn(
              ...
              <div class="ml-8 max-w-full xl:max-w-[70%]">
                ...
                <h5 class="mt-4 text-[14px] md:text-xs 2xl:text-base 3xl:text-[18px] text-white font-bold">
                  Thay đổi logo và hệ thống nhận diện mới
                </h5>
                <h5 class="mt-2 text-[14px] md:text-xs 2xl:text-base 3xl:text-[18px] text-white font-bold">
    ...
    <section class="container">
      <div class="flex lg:hidden flex-col items-center mt-12">
        ...
        <p class="mt-4 text-center text-xs md:text-sm 3xl:text-lg text-[#000] font-medium">
