<template>
	<div class="animate-about">
			...
			<div class="pt-0 pb-10 md:py-8 xl:py-16">
				<div class="px-0 md:px-10 xl:px-20">
					<div class="py-5 xl:py-14">
						...
						>
							UPS không chỉ là một công ty chứng khoán thông thường, chúng tôi hướng đến mục tiêu trở
							thành một điểm tựa vững chắc khuyến khích người trẻ tự tin khám phá thế giới tài chính. Kết
							hợp công nghệ tiên tiến cùng tư duy liên tục đổi mới để tạo ra những sản phẩm, dịch vụ đầu
							tư đáp ứng sát sao nhu cầu, mong muốn của nhà đầu tư.
						</p>
					</div>
				</div>
		...
		>
			<div class="pt-5 md:pt-24 pr-4 pb-4 w-full md:w-[560px] xl:w-[1050px] h-[420px] md:h-[566px] xl:h-[960px]">
				<div
			...
			>
				<div class="container">
					<div class="mb-6 md:mb-[90px] xl:mb-[130px]">
						...
						>
							Trở thành Công ty chứng khoán bán lẻ hàng đầu cung cấp các giải pháp tài chính đầu tư cá
							nhân dành cho thế hệ trẻ
						</p>
					</div>
			...
			>
				...
				>
					...
					<div class="md:my-5 xl:my-10">
						...
						>
							Những nguyên tắc cơ bản, những giá trị quan trọng mà UPS và các thành viên cam kết thực hiện
						</p>
					</div>
				...
				>
					...
					<div class="animate-about__item static md:absolute xl:absolute left-0 top-[600px] w-full">
						...
						>
							...
							<p class="text-sm xl:text-[18px] text-[#000] text-center md:text-right xl:text-right">
								Chú trọng nâng cao kiến thức và kỹ năng đầu tư tài chính cho khách hàng.
							</p>
						</div>
					</div>
		...
		<section class="bg-[linear-gradient(81deg,#0E1F16_0.74%,#125933_87.97%)]">
			<div class="container">
				<div class="flex flex-col md:flex-row xl:flex-row py-10 md:py-[60px] xl:py-[100px]">
					<div class="">
						<div
							class="animate-about__item relative inline-flex items-center justify-center w-[100px] h-[45px] xl:w-[173px] xl:h-[78px]"
						>
						...
						<h3 class="text-[32px] md:text-[40px] xl:text-[76px] font-BG font-semibold leading-tight">
					...
					>
						...
						>
							<div
								:class="
									cn('flex w-3 xl:w-[18px] h-3 xl:h-[18px] rounded-[4px] bg-[#01C159]', {
										'shadow-[0_0_32px_0_#00FF75]': i == 1,
									})
								"
							></div>
							<div class="flex-1 ml-8 max-w-full md:max-w-[620px] xl:max-w-[620px]">
								<p
									class="text-base md:text-[24px] xl:text-[40px] text-white font-BG font-semibold leading-[0.6]"
								>
									2024
								</p>
		...
		<section class="container">
			<div class="flex md:hidden flex-col items-center">
				...
				<p class="mt-4 text-center text-xs text-[#000] font-medium">
					Chúng tôi luôn nỗ lực không ngừng để đạt được những mục tiêu đầy tham vọng và tạo ra những giá trị
					lâu dài
				</p>
			</div>
			...
			>
				...
				>
					...
					<h4 class="text-right text-[40px] xl:text-[76px] font-semibold font-BG leading-tight">
