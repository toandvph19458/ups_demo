  ...
  <div class="animate-about">
    ...
    <section class="container">
      <div class="pt-0 pb-10 md:py-8 xl:py-16">
        <div class="px-0 md:px-10 xl:px-20">
          <div class="py-5 xl:py-14">
            <div class="flex justify-between">
              ...
              <div
                class="w-[48px] h-[48px] xl:w-[90px] xl:h-[90px] inline-flex items-center justify-center bg-[#15171E] rounded-full animate-about__item"
              >
            ...
            <h2
              class="animate-about__item text-[36px] xl:text-[64px] font-bold font-BG text-green-ups"
            >
              Về chúng tôi
            </h2>

            <p
              class="animate-about__item max-w-full xl:max-w-[634px] text-sm lg:text-base xl:text-lg text-[#3C4052] font-medium mt-5 xl:mt-8"
            >
    ...
    <!-- SECTION VISION -->
    <section
      class="flex flex-col-reverse md:flex-row xl:flex-row justify-end bg-[#1D1E22] rounded-es-[30px] rounded-ee-[30px] overflow-hidden relative"
    >
      <div
        class="pt-5 md:pt-24 pr-4 pb-4 w-full md:w-[560px] xl:w-[1050px] h-[420px] md:h-[566px] xl:h-[960px]"
      >
        <div
          class="animate-about__item relative w-full md:w-[560px] xl:w-[1050px] h-[420px] md:h-[566px] xl:h-[960px]"
        >
          <nuxt-img
            format="webp"
            loading="lazy"
            alt="UPS"
            src="/background/bg-03.png"
            class="absolute w-full h-full object-contain"
          />
        </div>
      </div>
      ...
      <div
        class="relative md:absolute xl:absolute w-full h-max pt-6 md:pt-0 top-0 md:1/2 xl:top-1/2 left-0 right-0 translate-y-0 md:-translate-y-1/2 xl:-translate-y-1/2"
      >
        <div class="container">
          <div class="mb-6 md:mb-[90px] xl:mb-[130px]">
            <div
            ...
            <h3
              class="animate-about__item text-[32px] md:text-[40px] xl:text-[76px] text-green-ups font-bold font-BG"
            >
              Tầm nhìn
            </h3>

            <p
              class="animate-about__item max-w-[685px] text-[14px] md:text-[16px] xl:text-[30px] text-[#D6DAEA] font-semibold mt-6"
            >
          ...
          >
            <h4
              class="text-[28px] xl:text-[52px] text-[#D6DAEA] font-bold font-BG group-hover:text-green-500"
            >
              Sứ mệnh
            </h4>
            <p
            ...
            <div
              class="absolute -top-10 right-6 flex items-center -rotate-[35deg] translate-x-full"
            >
    ...
    <section class="container">
      ...
      >
        <div
          class="w-full max-w-full md:max-w-[200px] xl:max-w-[360px] flex gap-4 md:gap-0 xl:gap-0 flex-col x; items-center lg:items-start xl:items-start"
        >
          <div
        ...
        <div
          class="flex-1 w-full grid gap-5 md-gap-0 xl:gap-0 grid-cols-2 md:flex xl:flex justify-center relative"
        >
          <div class="hidden md:inline-flex xl:inline-flex -translate-x-1/2">
            ...
            >
              ...
              <path
                id="path2"
                d="M281 1075L281 290.893C281 266.223 265.9 244.068 242.939 235.048L39.0609 154.952C16.0998 145.932 1.00001 123.777 1.00002 99.1074L1.00006 0"
                stroke="url(#paint0_radial_530_1358)"
                stroke-width="2"
              />
              <defs>
                <radialGradient
                  id="paint0_radial_530_1358"
                  cx="0"
                  cy="0"
                  r="1"
          ...
          <div
            class="animate-about__item static md:absolute xl:absolute left-0 top-[260px] xl:top-[285px] w-full"
          >
            <div
            ...
            >
              ...
              <p
                class="text-sm xl:text-[18px] text-[#000] text-center md:text-right xl:text-right"
              >
          ...
          <div
            class="animate-about__item static md:absolute xl:absolute left-0 top-[600px] w-full"
          >
            <div
              class="flex flex-col items-center md:items-end xl:items-end max-w-full md:max-w-[234px] xl:max-w-[440px] relative"
            >
          ...
          <div
            class="animate-about__item static md:absolute xl:absolute left-0 top-[920px] w-full"
          >
            <div
              class="flex flex-col items-center md:items-end xl:items-end max-w-full md:max-w-[234px] xl:max-w-[440px] relative"
            >
          ...
          >
            ...
            >
              ...
              <p
                class="text-sm xl:text-[18px] text-[#000] text-center md:text-right xl:text-left"
              >
          ...
          >
            ...
            >
              ...
              <p
                class="text-sm xl:text-[18px] text-[#000] text-center md:text-left xl:text-left"
              >
                Đặt lợi ích và trải nghiệm của khách hàng lên hàng đầu.
              </p>
            </div>
    ...
    <section class="bg-[linear-gradient(81deg,#0E1F16_0.74%,#125933_87.97%)]">
      <div class="container">
        <div
          class="flex flex-col md:flex-row xl:flex-row py-10 md:py-[60px] xl:py-[100px]"
        >
          <div class="">
            <div
              class="animate-about__item relative inline-flex items-center justify-center w-[100px] h-[45px] xl:w-[173px] xl:h-[78px]"
            ...
            <h3
              class="text-[32px] md:text-[40px] xl:text-[76px] font-BG font-semibold leading-tight"
            >
              <span class="text-white">Chặng đường</span>
              <br />
              <span class="text-green-ups">phát triển</span>
            </h3>
          </div>

          <div
            class="ml-0 md:ml-[140px] xl:ml-[350px] mt-10 md:mt-0 flex flex-col gap-12 relative after:content-[''] after:absolute after:left-[6px] xl:after:left-[9px] after:bottom-[-40px] xl:after:bottom-[-100px] after:w-[1px] after:h-[calc(100%+40px)] xl:after:h-[calc(100%+100px)] after:bg-[#01C159]"
          >
            <div class="flex group">
              ...
              ></div>
              <div
                class="flex-1 ml-8 max-w-full md:max-w-[620px] xl:max-w-[620px]"
              >
                <p
                ...
                <h5
                  class="mt-4 text-sm md:text-base xl:text-lg text-white font-bold"
                >
                  Thay đổi logo và hệ thống nhận diện mới
                </h5>
                <h5
                  class="mt-2 text-sm md:text-base xl:text-lg text-white font-bold"
                >
    ...
    <section class="container">
      <div class="flex md:hidden flex-col items-center">
        ...
        <h4 class="text-center text-[40px] font-semibold font-BG leading-tight">
          Chứng chỉ
          <span class="text-green-ups">và giấy phép</span>
        </h4>

        <p class="mt-4 text-center text-xs text-[#000] font-medium">
      ...
      <div
        class="py-12 md:py-[80px] xl:pt-[160px] xl:pb-[140px] hidden md:grid gap-x-8 gap-y-8 xl:gap-x-10 xl:gap-y-16 grid-cols-3"
      >
        <div
        ...
        >
          ...
          <h4
            class="text-right text-[40px] xl:text-[76px] font-semibold font-BG leading-tight"
          >
          ...
          <p class="text-right text-xs md:text-lg text-[#000] font-medium">
          ...
          <div class="animate-about__item inline-flex my-6">
            <nuxt-link target="_blank" to="http://api.upse.vn/assets/d0ddc150-6ab3-40d3-9996-eba9abe8800b" class="btn active group">
