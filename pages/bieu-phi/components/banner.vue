<template>
  <div
    class="pb-[100px] rounded-t-3xl bg-[linear-gradient(145deg,#8A6AFF_36.89%,rgba(0,148,255,0.10)_129.39%),url('/images/banner-bieu-phi.png')] bg-no-repeat bg-cover bg-center">
    <div class="container flex justify-center items-center">
      <div
        ...
        <div
          class="grid md:grid-cols-4 grid-cols-2 items-center gap-3 md:gap-2 lg:gap-3 2xl:gap-8 xl:gap-6 3xl:layout 3xl:gap-10 justify-center">
          <div
