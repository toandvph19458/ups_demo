<template>
	<footer id="footer">
		<div class="bg-gradient-to-l from-[#02E56A] to-[#0AB157] from-30% to-95%">
			<div class="container">
				<div class="h-max grid grid-cols-12 py-10 lg:pt-12 lg:pb-20 xl:py-[100px] gap-y-8 md:gap-10 lg:gap-0">
								...
								<div class="w-full flex flex-col gap-3 md:gap-4 mt-6 xl:mt-10">
									...
									>
										...
										<span class="text-sm 2xl:text-lg 3xl:text-xl text-[#15171E] font-bold">
											Địa chỉ: Tầng 12, tòa nhà CDC số 25 phố Lê Đại Hành, Phường Lê Đại Hành,
									...
									<nuxt-link
										href="mailto:info@upstock.com.vn"
										class="flex items-start gap-2"
									>
										<nuxt-img
											format="webp"
					...
					<div
						class="col-span-full md:col-span-6 lg:col-span-7 flex flex-col justify-between w-full gap-8 lg:gap-0"
					>
						<div class="grid grid-cols-12 gap-y-7 gap-x-0 md:gap-x-4 md:gap-7 2xl:gap-10">
							...
							<div class="col-span-6 lg:col-span-3">
								<h4 class="text-sm 2xl:text-lg 3xl:text-xl text-[#000] font-bold">Đầu tư cùng UPS</h4>
