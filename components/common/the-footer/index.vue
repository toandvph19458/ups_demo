<template>
	<footer id="footer">
		<div class="bg-gradient-to-l from-[#02E56A] to-[#0AB157] from-30% to-95%">
			<div class="container">
				<div class="h-max grid grid-cols-12 py-10 lg:pt-12 lg:pb-20 xl:py-[100px] gap-8 md:gap-10 lg:gap-0">
						...
						<div class="w-full lg:w-[75%]">
							...
							<div class="flex flex-col">
								<div class="w-full flex flex-col gap-3 md:gap-4 mt-6 xl:mt-10">
									...
									<nuxt-link href="tel:0243.944.6666" class="flex items-start gap-2">
							...
							<div class="mt-3 md:mt-4 flex gap-4">
								<nuxt-link href="/" target="_blank"
									class="inline-flex items-center justify-center relative w-[18px] 2xl:w-6 h-[18px] 2xl:h-6">
									<nuxt-img format="webp" loading="lazy" alt="Facebook" width="24"
										src="/social/facebook.svg" class="absolute w-full h-full object-contain" />
								</nuxt-link>
								<nuxt-link href="/" target="_blank"
									class="inline-flex items-center justify-center relative w-[18px] 2xl:w-6 h-[18px] 2xl:h-6">
									<nuxt-img format="webp" loading="lazy" alt="instagram" width="24"
										src="/social/instagram.svg" class="absolute w-full h-full object-contain" />
								</nuxt-link>
								<nuxt-link href="/" target="_blank"
									class="inline-flex items-center justify-center relative w-[18px] 2xl:w-6 h-[18px] 2xl:h-6">
									<nuxt-img format="webp" loading="lazy" alt="Twitter" width="24"
										src="/social/twitter.svg" class="absolute w-full h-full object-contain" />
								</nuxt-link>
								<nuxt-link href="/" target="_blank"
									class="inline-flex items-center justify-center relative w-[18px] 2xl:w-6 h-[18px] 2xl:h-6">
									<nuxt-img format="webp" loading="lazy" alt="Tiktok" width="24"
										src="/social/tiktok.svg" class="absolute w-full h-full object-contain" />
								</nuxt-link>
								<nuxt-link href="/" target="_blank"
									class="inline-flex items-center justify-center relative w-[18px] 2xl:w-6 h-[18px] 2xl:h-6">
									<nuxt-img format="webp" loading="lazy" alt="Telegram" width="24"
										src="/social/telegram.svg" class="absolute w-full h-full object-contain" />
								</nuxt-link>
								<nuxt-link href="/" target="_blank"
									class="inline-flex items-center justify-center relative w-[18px] 2xl:w-6 h-[18px] 2xl:h-6">
									<nuxt-img format="webp" loading="lazy" alt="Lulu" width="24" src="/social/lulu.svg"
					...
					<div class="col-span-full md:col-span-6 lg:col-span-7 flex flex-col justify-between w-full gap-8 lg:gap-0">
						<div class="grid grid-cols-12 gap-y-7 gap-x-0 md:gap-x-4 md:gap-7 2xl:gap-10">
							<div class="col-span-6 lg:col-span-3 space-y-[8px] 3xl:space-y-3">
						...
						<div class="flex gap-4 flex-wrap">
							...
							<nuxt-link to="https://webtrading.upse.vn/"
								...
								<span class="text-sm 3xl:text-lg font-bold"> Đăng nhập/Giao dịch ngay
								</span>
			...
			<div class="container">
				<div
					...
					<p class="text-[10.5px] 2xl:text-sm text-white opacity-75">
						© 2024 <span class="text-green-ups">UP Securities</span>. All right reserved
					</p>
