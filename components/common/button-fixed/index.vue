<template>
    ...
    <div class="fixed bottom-4 right-4 z-50">
        <transition name="slide-up">
            <div v-show="isListVisible"
                ...
                <div class="flex items-center justify-center bg-black rounded-full cursor-pointer">
                    <img src="/icons/mess.png" alt="Telegram" class="w-[40px] h-[40px] object-cover" />
                </div>
                <div class="flex items-center justify-center bg-black rounded-full cursor-pointer">
                    <img src="/icons/tele.png" alt="Zalo" class="w-[40px] h-[40px] object-cover" />
                </div>
                <div class="flex items-center justify-center bg-black rounded-full cursor-pointer">
                    <img src="/icons/zalo-btn.png" alt="Zalo" class="w-[40px] h-[40px] object-cover" />
                </div>
            </div>
        </transition>
        ...
        <i :class="{
            ...
            @click="toggleList">
            <!-- SVG với màu stroke động dựa trên isListVisible và hover -->
            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                <path
                    ...
                    stroke="#02E56A" stroke-width="2.25" stroke-miterlimit="10" />
            </svg>
        </i>

        <!-- Nút Back to Top -->
        <div class="group">
            <i v-show="showBackToTop" :class="{
                'bg-black': isHovered,
                'bg-[#02E56A]': !isHovered,
                'hover:bg-black': true,
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                    <path :stroke="isHovered ? '#02E56A' : '#000000'"
                        d="M30.1168 15.9502L20.0001 5.8335L9.88342 15.9502" stroke-width="2.5" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                    <path :stroke="isHovered ? '#02E56A' : '#000000'" d="M20 34.1667V6.1167" stroke-width="2.5"
