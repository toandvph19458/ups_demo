						...
						<swiper-slide>
							...
							>
								...
								<div
									:class="
										cn(
											'w-full flex-1 p-5 md:p-10 flex flex-col justify-start md:justify-between transition-all duration-500 bg-white min-h-[220px]',
											{
												'bg-white': vSwiperIndex == 3,
											}
										)
									"
								>
