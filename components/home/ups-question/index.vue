						...
						<swiper-slide>
							...
							>
								...
								<div
									:class="
										cn(
											'w-full flex-1 p-5 md:p-10 flex flex-col justify-between bg-[#0D8357] bg-[linear-gradient(0deg,rgba(0,0,0,0.3)_0%,rgba(0,0,0,0.3)_100%)] transition-all duration-500',
											{
								...
								>
									...
									<div class="mt-2 md:mt-0 text-sm text-[#033E1E]">
										<p class="text-[16px]">
											...
											nhân không giới hạn dành cho các nhà đầu tư Gen Z thế hệ mới.
										</p>
									</div>
								</div>
							</nuxt-link>
