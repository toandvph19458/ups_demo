    ...
    <div class="container">
      <div class="w-full">
        ...
        <div class="mt-3 md:mt-5 xl:mt-10">
          ...
          <p
            class="animate-ups__item text-sm md:text-base xl:text-xl text-center text-[#000] font-medium"
          >
            ...
            <swiper-slide>
              ...
              >
                <div
                  :class="
                    cn(
                      'w-full max-w-full md:max-w-[360px] flex flex-col bg-[#0A2E20]'
                    )
                  "
                >
                  <div
                    class="relative overflow-hidden w-full h-[280px] md:h-[450px] rounded-[24px] md:rounded-none"
                  >
                    <nuxt-img
                      format="webp"
                      loading="lazy"
                  ...
                  <div
                    class="flex-1 hidden md:flex xl:flex justify-center pb-4"
                  >
                    <nuxt-img
                      format="webp"
                      loading="lazy"
                ...
                <div
                  :class="
                    cn(
                      'p-5 md:p-10 flex flex-col justify-between bg-[#0D8357] bg-[linear-gradient(0deg,rgba(0,0,0,0.3)_0%,rgba(0,0,0,0.3)_100%)] transition-all duration-500',
                      {
                        'bg-[linear-gradient(294deg,_#03AF52_2.49%,_#04C85E_72.5%)]':
                          vSwiperIndex == 0,
                      }
                    )
                  "
                >
                  <div class="flex gap-5 items-center">
                    ...
                    >
                      Tôi có thể mở tài khoản giao dịch tại UPS qua hình thức
                      nào?
                    </h4>
                  ...
                  <div class="mt-2 md:mt-0 text-sm text-[#033E1E]">
                    ...
                    <p class="text-[16px]">
                      Cách 1: Mở tài khoản trực tuyến qua website tại đây
                    </p>
                    <p>
                      Cách 2: Mở tài khoản trực tiếp tại quầy giao dịch của VPS.
                    </p>
                    <p class="pt-2 text-[16px]">
                      Để được hỗ trợ thêm, vui lòng liên hệ hotline
                      0243.944.6666
                    </p>
                  </div>
                </div>
            ...
            <swiper-slide>
              ...
              >
                ...
                >
                  ...
                  <div class="mt-2 md:mt-0 text-sm text-[#033E1E]">
                    <p class="text-[16px]">
                      UPS cung cấp mức phí giao dịch rất hấp dẫn trong các công
                      ty chứng khoán tại Việt Nam  Để theo dõi thông tin chi
                      tiết, bạn vui lòng truy cập thông báo Biểu phí cập
                      nhật  UPS liên tục triển khai các chương trình khuyến mãi
                      và ưu đãi lãi suất. Bạn vui lòng theo dõi website và
                      facebook của chúng tôi tại đây để nắm được chi tiết về các
                      chương trình.
                    </p>
                  </div>
                </div>
            ...
            <swiper-slide>
              ...
              >
                ...
                >
                  ...
                  <div class="mt-2 md:mt-0 text-sm text-[#033E1E]">
                    <p class="text-[16px]">
                      UPS không chỉ cung cấp dịch vụ đầu tư minh bạch, đáng tin
                      cậy, đem lại nguồn lợi nhuận đa dạng, mà còn mong muốn trở
                      thành người bạn đồng hành, trợ thủ đắc lực truyền cảm hứng
                      trong hành trình học hỏi và kiến tạo tài chính cá nhân
                      không giới hạn dành cho các nhà đầu tư Gen Z thế hệ mới.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <swiper-slide>
              ...
              >
                ...
                >
                  ...
                  <div class="mt-2 md:mt-0 text-sm text-[#033E1E]">
                    <p class="text-[16px]">
                      Để sử dụng App Trading, Web Trading, bảng giá giao dịch
                      cũng như tìm hiểu các sản phẩm, dịch vụ, điều khoản, bạn
                      vui lòng tham khảo hướng dẫn giao dịch tại đây.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <path
                    ...
                    :class="
                      cn(
                        'transition-all duration-300 group-hover:fill-[#15171E]',
                        {
                  ...
                  <path
                    ...
                    :class="
                      cn(
                        'transition-all duration-300 group-hover:fill-[#15171E]',
                        {
                          'group-hover:fill-[#02E56A]': vSwiperIndex === 4,
                        }
                      )
                    "
                  />
