  ...
  <section class="animate-ups mt-11 relative">
    ...
    <div class="w-[calc(100%-24px)] md:w-full lg:ml-10 xl:ml-auto mr-0">
      <div class="pt-0 md:pt-20 xl:pt-[100px]">
          ...
          <swiper-slide>
            ...
            >
              <div class="w-full md:max-w-[500px] xl:max-w-[768px]">
                ...
                <div
                  class="btn-wrapper flex gap-5 items-center mt-10 pl-1 pb-2"
                >
        ...
        <div
          class="w-full h-20 md:h-[100px] max-h-full flex items-center relative"
        >
          ...
          <div
            class="flex gap-2 absolute top-1/2 left-[calc(50%-24px)] -translate-x-1/2 -translate-y-1/2"
          >
