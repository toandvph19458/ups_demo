  ...
  <section class="animate-ups mb-[100px] md:mb-[180px] xl:mb-[230px]">
    <div class="bg-custom">
      <div class="container">
        ...
        >
          <div
            class="col-span-1 order-2 lg:order-1 h-full pt-4 md:pt-0 lg:pt-16"
          >
            <div class="relative w-full h-full">
              <div class="flex flex-col justify-start h-full gap-28">
                ...
                >
                  <span
                    class="text-[#02E56A] text-[32px] xl:text-[40px] 2xl:text-[44px] 3xl:text-6xl"
                    >UPS</span
                  >
          ...
          >
            ...
            <p
              class="animate-ups__item text-xs xl:text-base 3xl:text-xl text-[#EEEEEE] font-normal"
            >
            ...
            <div
              class="grid grid-cols-2 mt-4 md:mt-5 lg:mt-8 xl:mt-12 3xl:mt-16"
            >
              <div class="animate-ups__item pr-5 md:pr-[40px] xl:pr-[60px]">
                ...
                <p
                  class="text-xs xl:text-base 3xl:text-xl text-[#EEEEEE] font-normal"
                >
