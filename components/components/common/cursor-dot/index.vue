<template>
    <div class="cursor_dot fixed top-0 left-0 z-[9999] pointer-events-none bg-[#02E56A] rounded-full">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <defs>
                        <filter id="filter0_d_129_13421" x="0.67627" y="0.25" width="19.5" height="19.5"
                            ...
                            <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_129_13421" />
    ...
    setup() {
        onMounted(() => {
            ...
            document.addEventListener('mousemove', () => {
                const isHovered = Array.from(btns).some(btn => btn.matches(':hover')) ||
