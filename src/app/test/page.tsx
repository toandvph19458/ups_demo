...
const NavigationMenuDemo = () => {
  return (
    <NavigationMenu.Root className="relative z-10 mt-28 flex w-screen justify-center">
      <NavigationMenu.List className="center shadow-blackA4 m-0 flex list-none rounded-md bg-white p-1 shadow-[0_2px_10px]">
        <NavigationMenu.Item>
          <NavigationMenu.Trigger className="text-violet11 hover:bg-violet3 focus:shadow-violet7 group flex select-none items-center justify-between gap-0.5 rounded px-3 py-2 text-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]">
            Learn{' '}
            <CaretDownIcon
              className="text-violet10 duration-[250] relative top-px transition-transform ease-in group-data-[state=open]:-rotate-180"
              aria-hidden
            />
